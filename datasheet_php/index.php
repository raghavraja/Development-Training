...
<div class="message">
<form name="fname" method="post" action="insert.php">
<div class="num">
<input type="text" class="rbm" name="production" id="parameters" onkeyup=myFunction();>
</div>
<div class="mark">
<input type="text" id="score" name="value1">
</div>
<div class="dis" id="description">
<textarea class="area" name="value2"></textarea>
</div>
</div>
</div>
<div class="spc">
...
<div class="message">
<div class="num">
<input type="text" class="rbm" name="quality" id="ark" onkeyup=gama();>
</div>
<div class="mark">
<input type="text" name="value3" id="ssm">
</div>
<div class="dis" id="max">
<textarea name="value4" class="area"></textarea>
</div>
</div>
</div>
</div>
...
<div class="message">
<div class="num">
<input type="text" class="rbm" name="certification" id="before" onkeyup=sky();>
</div>
<div class="mark">
<input type="text" name="value5" id="alpha">
</div>
<div class="dis" id="marks">
<textarea class="area" name="value6" ></textarea>
</div>
</div>
</div>
</div>
...
<div class="message">
<div class="num">
<input type="text" class="rbm" name="training" id="ball" onkeyup=beta();>
</div>
<div class="mark">
<input type="text" name="value7" id="king">

</div>
<div class="dis" id="mrc">
<textarea class="area" name="value8"></textarea>
</div>
</div>
</div>
<div class="spc">
...
<div class="message">
<div class="num">
<input type="text" class="rbm" name="analysis" id="blank" onkeyup=ray();>
</div>
<div class="mark">
<input type="text" name="value9" id="fit">
</div>
<div class="dis" id="shine">
<textarea class="area" name="value10"></textarea>
</div>
</div>
</div>
</div>
...
<div class="message">
<div class="num">
<input type="text" class="rbm" name="attendance" id="rwb" onkeyup=micro();>
</div>
<div class="mark">
<input type="text" name="value11" id="sibe">
</div>
<div class="dis" id="local">
<textarea class="area" name="value12"></textarea>
</div>
</div>
</div>
</div>
